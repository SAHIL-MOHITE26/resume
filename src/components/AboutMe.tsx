...
const AboutMe: React.FC = () => {
  return (
    <div className="w-[1568px] ml-[-24px] p-4 sm:p-6 mb-[-60px]">
      {/* Add rounded-lg to this outer div to round all corners */}
      <div className="bg-white shadow-lg rounded-t-2xl p-6 mt-[-40px]">
        ...
        <section className="mb-8 flex flex-col sm:flex-row">
          <div className="flex-1 mb-4 sm:mb-0 sm:mr-4">
            ...
            <a
              href="https://drive.google.com/file/d/1876GR4qdVvc45DDEGwyf8HhgXszM3SVy/view?usp=sharing" // Replace with the actual path to your PDF
